...
import { OAppReadUpgradeable } from "./OAppRead/OAppReadUpgradeable.sol";
import { OAppOptionsType3Upgradeable } from "./OAppRead/OAppOptionsType3Upgradeable.sol";
import { IPriceFeed } from "./PriceFeed.sol";

contract ReadPublicUpgradeable is OAppReadUpgradeable, OAppOptionsType3Upgradeable {
    ...
    function initialize(address _endpoint, address _delegate, uint32 _readChannel) public initializer {
        OAppReadUpgradeable.__OAppRead_init(_endpoint, _delegate);
